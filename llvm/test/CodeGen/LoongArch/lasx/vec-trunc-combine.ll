...
; LA32:       # %bb.0:
; LA32-NEXT:    xvpickev.w $xr0, $xr0, $xr1
; LA32-NEXT:    xvpermi.d $xr0, $xr0, 216
; LA32-NEXT:    xvpickev.h $xr0, $xr0, $xr0
; LA32-NEXT:    xvpermi.d $xr0, $xr0, 216
; LA32-NEXT:    vpickev.b $vr0, $vr0, $vr0
...
; LA64:       # %bb.0:
; LA64-NEXT:    xvpickev.w $xr0, $xr0, $xr1
; LA64-NEXT:    xvpermi.d $xr0, $xr0, 216
; LA64-NEXT:    xvpickev.h $xr0, $xr0, $xr0
; LA64-NEXT:    xvpermi.d $xr0, $xr0, 216
; LA64-NEXT:    vpickev.b $vr0, $vr0, $vr0
...
; LA32:       # %bb.0:
; LA32-NEXT:    xvpickev.h $xr0, $xr0, $xr1
; LA32-NEXT:    xvpermi.d $xr0, $xr0, 216
...
; LA64:       # %bb.0:
; LA64-NEXT:    xvpickev.h $xr0, $xr0, $xr1
; LA64-NEXT:    xvpermi.d $xr0, $xr0, 216
...
; LA32:       # %bb.0:
; LA32-NEXT:    xvpickev.w $xr2, $xr2, $xr3
; LA32-NEXT:    xvpermi.d $xr2, $xr2, 216
; LA32-NEXT:    xvpickev.w $xr0, $xr0, $xr1
; LA32-NEXT:    xvpermi.d $xr0, $xr0, 216
; LA32-NEXT:    xvpickev.h $xr0, $xr0, $xr2
; LA32-NEXT:    xvpermi.d $xr0, $xr0, 216
; LA32-NEXT:    xvpickev.b $xr0, $xr0, $xr0
; LA32-NEXT:    xvpermi.d $xr0, $xr0, 216
; LA32-NEXT:    # kill: def $vr0 killed $vr0 killed $xr0
...
; LA64:       # %bb.0:
; LA64-NEXT:    xvpickev.w $xr2, $xr2, $xr3
; LA64-NEXT:    xvpermi.d $xr2, $xr2, 216
; LA64-NEXT:    xvpickev.w $xr0, $xr0, $xr1
; LA64-NEXT:    xvpermi.d $xr0, $xr0, 216
; LA64-NEXT:    xvpickev.h $xr0, $xr0, $xr2
; LA64-NEXT:    xvpermi.d $xr0, $xr0, 216
; LA64-NEXT:    xvpickev.b $xr0, $xr0, $xr0
; LA64-NEXT:    xvpermi.d $xr0, $xr0, 216
; LA64-NEXT:    # kill: def $vr0 killed $vr0 killed $xr0
...
; LA32-NEXT:    xvpickev.w $xr0, $xr0, $xr1
; LA32-NEXT:    xvpermi.d $xr0, $xr0, 216
; LA32-NEXT:    xvpickev.w $xr1, $xr2, $xr3
...
; LA64-NEXT:    xvpickev.w $xr0, $xr0, $xr1
; LA64-NEXT:    xvpermi.d $xr0, $xr0, 216
; LA64-NEXT:    xvpickev.w $xr1, $xr2, $xr3
